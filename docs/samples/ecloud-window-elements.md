...
- Captured at: 2026-04-25 16:31:39 +08:00
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | `0x70526` | `0x30494` | `Chrome_RenderWidgetHostHWND` | `Chrome Legacy Window` | False | True | `(-25600, -25600) - (-23552, -24320) 2048x1280` | 495888 |
